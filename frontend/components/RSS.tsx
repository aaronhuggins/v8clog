...
import { h, xml, createXMLHandler } from "../jsx.ts"
  ...
  return (
    <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
      <channel>
          ...
          <atomLink href={`${origin}/rss.xml`} rel="self" type="application/rss+xml" />
          {
            data.map(val => (<RSSItem detail={val.detail} data={val.features} origin={origin} />))
          }
      </channel>
    </rss>
  )
